...
| ref_strain    | float                                                                                         | Reference strain for equivalent linear analysis. Required when soil_model is 'equivalent_linear'. Reference strain for modulus reduction. | `None`             |
...
| ref_strain       | (float, optional)           | Reference strain for equivalent linear analysis. Required when soil_model is 'equivalent_linear'. Reference strain for modulus reduction. |
